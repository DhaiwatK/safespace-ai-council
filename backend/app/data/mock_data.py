    ...
    return [
        {
            ...
            "incident_location": "Kellogg Global Hub - Networking Event",
            "description": "During an off-campus networking event organized by Kellogg MBA program, respondent made repeated unwelcome sexual comments and physical contact despite clear requests to stop. Incident occurred over 3-week period with escalating behavior. Multiple witnesses present at final incident.",
            "is_ongoing": False,
            ...
            "evidence_summary": "Email correspondence, text messages, witness statements from 3 attendees"
        },
        {
            "id": "case_002",
        ...
        },
        {
            ...
            "incident_location": "Athletic Facility",
            "description": "Allegations of discriminatory treatment in athletic program selection process.",
            "is_ongoing": False,
            ...
            "complainant_demographics": "Not specified",
            "respondent_demographics": "Not specified",
            "evidence_summary": "Email correspondence, program roster data"
        }
    ]
